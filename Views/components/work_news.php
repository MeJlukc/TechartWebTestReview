<main class="work-news">
    <p class="work-news__path">
        <a class="work-news__path__link" href="/">Главная</a> / <span class="text-color--grey"><?=$news['title']?></span>
    </p>
    ...
    <div class="work-news__container">
        <div class="work-news__info">
            ...
            <a class="button work-news__button" href="/">Назад к новостям</a>
        </div>
        <div class="work-news__media">
            <img src="/assets/images/<?=$news['image']?>" alt="Selected news image" class="work-news__image">
        </div>
    </div>
</main>
